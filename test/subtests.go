...
func RunSubTestOrBenchmark(t TBI, name string, f func(t testing.TB)) bool {
	t.Helper()
...
func RunSubTest(t TI, name string, f func(t *testing.T)) bool {
	t.Helper()
	return t.Run(name, f)
}
...
func RunSubBenchmark(t BI, name string, f func(t *testing.B)) bool {
	t.Helper()
	return t.Run(name, f)
}
...
func RunRequiredSubTestOrBenchmark(t TBI, name string, f func(t testing.TB)) {
	t.Helper()
	tr := t.RunTB(name, f)
	if !tr {
...
func RunRequiredSubTest(t TI, name string, f func(t *testing.T)) {
	t.Helper()
	tr := t.Run(name, f)
	if !tr {
		t.Fatalf("Subtest %s failed but was required to continue", name)
...
func RunRequiredSubBenchmark(t BI, name string, f func(t *testing.B)) {
	t.Helper()
	tr := t.Run(name, f)
	if !tr {
		t.Fatalf("Subtest %s failed but was required to continue", name)
